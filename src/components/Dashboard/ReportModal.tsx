          ...
          <div className="flex-1 overflow-y-auto p-6">
            ...
            <div className="mb-8 p-6 bg-gradient-to-r from-blue-50 to-purple-50 rounded-xl">
              <div className="flex items-center justify-between">
                ...
                <div className={`text-4xl font-bold px-6 py-3 rounded-xl ${getScoreColor(report.debt_score)}`}>
              ...
              <div className="mb-8">
                ...
                <div className="space-y-4">
                  {Object.entries(report.file_analysis).slice(0, 10).map(([filePath, analysis]: [string, any]) => (
                    <div key={filePath} className="border border-gray-200 rounded-lg p-4">
                      <div className="flex justify-between items-start mb-3">
                        <h4 className="font-medium text-gray-900">{filePath}</h4>
                        <span className={`text-sm font-medium px-2 py-1 rounded ${getScoreColor(analysis.debt_score || 0)}`}>
