...
export const Landing: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-blue-50 dark:from-gray-900 dark:via-gray-900 dark:to-blue-900 transition-colors duration-500 relative">
      ...
      {/* Footer */}
      <footer className="bg-white/80 dark:bg-gray-900/80 backdrop-blur-xl border-t border-gray-200/20 dark:border-gray-700/20 py-12 relative">
          ...
          <div className="flex flex-col md:flex-row justify-between items-center space-y-6 md:space-y-0">
            ...
            >
              ...
              >
                ...
                />
                <span className="text-gray-700 dark:text-gray-300 font-medium">Bolt</span>
              </a>
            </motion.div>
          </div>
        </div>
